...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainTableView.setGeometry(QRect(70, 140, 971, 651))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QRect(70, 100, 971, 36))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QRect(1130, 660, 651, 36))
        ...
        self.horizontalLayoutWidget_5.setGeometry(QRect(1220, 99, 471, 41))
...
#if QT_CONFIG(tooltip)
        self.pushButton_6.setToolTip(QCoreApplication.translate("MainWindow", u"Inicia formul\u00e1rio para cadastro de nova cobran\u00e7a", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"Criar Um", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.pushButton_10.setText(QCoreApplication.translate("MainWindow", u"Editar", None))
#if QT_CONFIG(tooltip)
        self.pushButton_11.setToolTip(QCoreApplication.translate("MainWindow", u"Remove cobran\u00e7a selecionada.", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_11.setText(QCoreApplication.translate("MainWindow", u"Remover", None))
#if QT_CONFIG(tooltip)
